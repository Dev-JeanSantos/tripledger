# ADR-000 — Problem Definition and Guiding Principles
...
TripLedger will be implemented using:
- **Kotlin**
- **Spring Boot**
- **MongoDB**

The project is intended to serve as a professional portfolio artifact.
